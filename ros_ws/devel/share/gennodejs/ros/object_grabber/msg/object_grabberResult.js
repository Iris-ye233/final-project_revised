...
class object_grabberResult {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new object_grabberResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_grabberResult(null);
...
object_grabberResult.Constants = {
  SUCCESS: 0,
  OBJECT_ACQUIRED: 0,
...
module.exports = object_grabberResult;
