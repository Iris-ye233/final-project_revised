...
class object_grabberFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new object_grabberFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_grabberFeedback(null);
...
module.exports = object_grabberFeedback;
