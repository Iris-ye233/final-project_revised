...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<objectManipulationQuery-request>)))
  ...
  (cl:format cl:nil "#objectManipulationQuery service message codes~%# send request as a QUERY, e.g., what types of grasp strategies are available for specified object_ID and gripper_ID? ~%~%uint8 TEST_PING                         = 0~%uint8 GRASP_STRATEGY_OPTIONS_QUERY      = 1~%uint8 APPROACH_STRATEGY_OPTIONS_QUERY   = 2~%uint8 DEPART_STRATEGY_OPTIONS_QUERY     = 3~%~%uint8 GET_GRASP_POSE_TRANSFORMS         = 10~%uint8 GET_APPROACH_POSE_TRANSFORMS      = 11~%uint8 GET_DEPART_POSE_TRANSFORMS        = 12~%~%# Grasp options~%int32 GRASP_FROM_ABOVE                  = 0         # Approaches along normal to object towards grasp pose. Useful for toyblock, vacuum-gripper approach, etc.~%                                        ~%int32 GRASP_FROM_SIDE                   = 1         # I.e. grab bottle - power grasp.~%~%# Approach/depart options~%int32 APPROACH_Z_TOOL                   = 11        # Vertical descent along tool-z axis~%int32 DEPART_Z_TOOL                     = 12        # Vertical ascent~%~%int32 APPROACH_LATERAL_SLIDE            = 21        # Horizontal approach along tool y-axis~%int32 DEPART_LATERAL_SLIDE              = 22        # Horizontal departure~%~%int32 object_ID~%int32 gripper_ID~%uint8 query_code~%int32 grasp_option~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'objectManipulationQuery-request)))
  "Returns full string definition for message of type 'objectManipulationQuery-request"
  (cl:format cl:nil "#objectManipulationQuery service message codes~%# send request as a QUERY, e.g., what types of grasp strategies are available for specified object_ID and gripper_ID? ~%~%uint8 TEST_PING                         = 0~%uint8 GRASP_STRATEGY_OPTIONS_QUERY      = 1~%uint8 APPROACH_STRATEGY_OPTIONS_QUERY   = 2~%uint8 DEPART_STRATEGY_OPTIONS_QUERY     = 3~%~%uint8 GET_GRASP_POSE_TRANSFORMS         = 10~%uint8 GET_APPROACH_POSE_TRANSFORMS      = 11~%uint8 GET_DEPART_POSE_TRANSFORMS        = 12~%~%# Grasp options~%int32 GRASP_FROM_ABOVE                  = 0         # Approaches along normal to object towards grasp pose. Useful for toyblock, vacuum-gripper approach, etc.~%                                        ~%int32 GRASP_FROM_SIDE                   = 1         # I.e. grab bottle - power grasp.~%~%# Approach/depart options~%int32 APPROACH_Z_TOOL                   = 11        # Vertical descent along tool-z axis~%int32 DEPART_Z_TOOL                     = 12        # Vertical ascent~%~%int32 APPROACH_LATERAL_SLIDE            = 21        # Horizontal approach along tool y-axis~%int32 DEPART_LATERAL_SLIDE              = 22        # Horizontal departure~%~%int32 object_ID~%int32 gripper_ID~%uint8 query_code~%int32 grasp_option~%~%~%~%"))
