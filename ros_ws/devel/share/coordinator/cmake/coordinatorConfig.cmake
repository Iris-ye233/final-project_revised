...
if("TRUE" STREQUAL "TRUE")
  set(coordinator_SOURCE_PREFIX /home/yedi/ros_ws/src/learning_ros_noetic/Part_6/coordinator)
  set(coordinator_DEVEL_PREFIX /home/yedi/ros_ws/devel)
  ...
  set(coordinator_INSTALL_PREFIX /home/yedi/ros_ws/install)
...
if(NOT "/home/yedi/ros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'coordinator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yedi/ros_ws/src/learning_ros_noetic/Part_6/coordinator/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(coordinator_EXPORTED_TARGETS ${${coordinator_dep}_EXPORTED_TARGETS})
endforeach()
