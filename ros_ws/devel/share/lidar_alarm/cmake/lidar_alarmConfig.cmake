...
if("TRUE" STREQUAL "TRUE")
  set(lidar_alarm_SOURCE_PREFIX /home/yedi/ros_ws/src/learning_ros_noetic/Part_2/lidar_alarm)
  set(lidar_alarm_DEVEL_PREFIX /home/yedi/ros_ws/devel)
  ...
  set(lidar_alarm_INSTALL_PREFIX /home/yedi/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_alarm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yedi/ros_ws/src/learning_ros_noetic/Part_2/lidar_alarm/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(lidar_alarm_EXPORTED_TARGETS ${${lidar_alarm_dep}_EXPORTED_TARGETS})
endforeach()
