...
#endif
#if defined(_WIN32) && defined(PATH_HAS_DISCONTINUITIES)
  #undef PATH_HAS_DISCONTINUITIES
#endif
...
bool operator==(const ::arm_motion_action::arm_interfaceResult_<ContainerAllocator1> & lhs, const ::arm_motion_action::arm_interfaceResult_<ContainerAllocator2> & rhs)
{
  return lhs.return_code == rhs.return_code &&
    lhs.err_code == rhs.err_code &&
    lhs.num_path_segs == rhs.num_path_segs &&
    lhs.segmented_path_arrival_times == rhs.segmented_path_arrival_times &&
