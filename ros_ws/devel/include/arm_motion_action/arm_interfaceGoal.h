...
#endif
#if defined(_WIN32) && defined(TEST_PATH_FOR_DISCONTINUITIES)
  #undef TEST_PATH_FOR_DISCONTINUITIES
#endif
#if defined(_WIN32) && defined(GET_NUM_PATH_SEGMENTS)
  #undef GET_NUM_PATH_SEGMENTS
#endif
#if defined(_WIN32) && defined(GET_REPLANNED_ARRIVAL_TIMES)
  #undef GET_REPLANNED_ARRIVAL_TIMES
#endif
#if defined(_WIN32) && defined(REPLAN_DISCONTINUITIES)
  #undef REPLAN_DISCONTINUITIES
#endif
#if defined(_WIN32) && defined(REFINE_PLANNED_TRAJECTORY)
  #undef REFINE_PLANNED_TRAJECTORY
#endif
#if defined(_WIN32) && defined(SEGMENT_DISCONTINUOUS_TRAJ)
  #undef SEGMENT_DISCONTINUOUS_TRAJ
#endif
...
#endif
#if defined(_WIN32) && defined(GOTO_NSEG_START)
  #undef GOTO_NSEG_START
#endif
