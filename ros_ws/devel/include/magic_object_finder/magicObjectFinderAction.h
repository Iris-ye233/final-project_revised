...
bool operator==(const ::magic_object_finder::magicObjectFinderAction_<ContainerAllocator1> & lhs, const ::magic_object_finder::magicObjectFinderAction_<ContainerAllocator2> & rhs)
{
