...
bool operator==(const ::magic_object_finder::magicObjectFinderResult_<ContainerAllocator1> & lhs, const ::magic_object_finder::magicObjectFinderResult_<ContainerAllocator2> & rhs)
{
