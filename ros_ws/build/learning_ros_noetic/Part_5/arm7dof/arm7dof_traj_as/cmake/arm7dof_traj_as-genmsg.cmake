...
add_custom_target(_arm7dof_traj_as_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "arm7dof_traj_as" "/home/yedi/ros_ws/devel/share/arm7dof_traj_as/msg/trajResult.msg" ""
)

get_filename_component(_filename "/home/yedi/ros_ws/devel/share/arm7dof_traj_as/msg/trajFeedback.msg" NAME_WE)
add_custom_target(_arm7dof_traj_as_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "arm7dof_traj_as" "/home/yedi/ros_ws/devel/share/arm7dof_traj_as/msg/trajFeedback.msg" ""
)
