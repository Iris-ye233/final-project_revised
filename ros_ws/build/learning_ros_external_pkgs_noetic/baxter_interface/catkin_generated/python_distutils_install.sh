...
echo_and_run cd "/home/yedi/ros_ws/src/learning_ros_external_pkgs_noetic/baxter_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/home/yedi/ros_ws/src/learning_ros_external_pkgs_noetic/baxter_interface/setup.py" \
     \
    build --build-base "/home/yedi/ros_ws/build/learning_ros_external_pkgs_noetic/baxter_interface" \
    install \
    --root="${DESTDIR-/}" \
