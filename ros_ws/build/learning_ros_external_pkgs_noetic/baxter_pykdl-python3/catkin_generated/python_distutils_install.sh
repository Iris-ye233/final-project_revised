...
echo_and_run cd "/home/yedi/ros_ws/src/learning_ros_external_pkgs_noetic/baxter_pykdl-python3"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/yedi/ros_ws/src/learning_ros_external_pkgs_noetic/baxter_pykdl-python3/setup.py" \
     \
    build --build-base "/home/yedi/ros_ws/build/learning_ros_external_pkgs_noetic/baxter_pykdl-python3" \
    install \
    --root="${DESTDIR-/}" \
