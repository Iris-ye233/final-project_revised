...
echo_and_run cd "/home/yedi/ros_ws/src/learning_ros_external_pkgs_noetic/gazebo_ros_pkgs/gazebo_plugins"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/yedi/ros_ws/src/learning_ros_external_pkgs_noetic/gazebo_ros_pkgs/gazebo_plugins/setup.py" \
     \
    build --build-base "/home/yedi/ros_ws/build/learning_ros_external_pkgs_noetic/gazebo_ros_pkgs/gazebo_plugins" \
    install \
    --root="${DESTDIR-/}" \
